    ...
    <div className=' bg-myWhite w-full h-[80%] rounded-t-[2.3rem] '>
      <div className='flex justify-center flex-col items-center'>
          ...
          <form className='flex items-center flex-col space-y-3 relative' action="">
              <input className='p-2 rounded-md text-sm w-[130%]  focus:bg-slate-200 focus:outline-myBlue' type="text" placeholder='Enter your email' />
              <input className='p-2 rounded-md text-sm w-[130%] focus:bg-slate-200  focus:outline-myBlue' type="password" placeholder='Enter your password' />
              <IoEye className='absolute top-[45px] left-[215px] text-gray-400' />
              <p className='text-[9px] font-bold text-right w-full'>Forgot Password?</p>
              <button type='submit' className='text-myWhite text-sm font-myFont bg-myBlue w-[130%] p-2 rounded-2xl font-bold'>Login</button>
              ...
              <p className=' absolute  text-myBlack text-[12px] font-myFont font-bold   -bottom-20  '>Don’t have an account? <Link href={"/register"}> <span className='text-myBlue cursor-pointer'>Register Now</span></Link></p>
          </form>
      </div>
